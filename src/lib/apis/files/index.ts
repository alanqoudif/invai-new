...
export const uploadFile = async (token: string, file: File, metadata?: object | null, access_control?: object | null) => {
	...
	if (access_control) {
		data.append('access_control', JSON.stringify(access_control));
	}
